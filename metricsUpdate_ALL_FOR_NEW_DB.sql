...
AS
  ...
  BEGIN TRY
    ...
    (
      ...
      keyID                 int NULL,
      keyText               nvarchar(1000) NULL,
      subjectLookupTableID  int NULL,
      keyLookupTableID      int NULL,
      absoluteValue         bit NULL,
      units                 varchar(20) NULL,
      aggregateFunction    varchar(20) NULL,
      label                nvarchar(200) NULL,
      severityThreshold    float NULL,
      goal                 float NULL,
      goalType             char(1) NULL,
      goalDirection        char(1) NULL,
      date8                 date NULL,
      value8                float NULL,
      date7                 date NULL,
      value7                float NULL,
